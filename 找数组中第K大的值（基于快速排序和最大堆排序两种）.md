...
1. 基本堆排序。最大堆（ai >= 2*ai and >= 2*ai+1)，父节点值永远比子节点大，i是父节点index，2*ai就是左子。最小堆（ai <= 2*ai and <= 2*ai+1)。每次维护一个最大堆，保证正最顶上那个节点是最大值，然后把它丢到最后一个节点的位置，剩下的元素中再维护最大堆得到新的最大值的头结点，依次重复。
   ...
   ![img](1024555-20161217182750011-675658660.png)
...
<img src="4131789-42be3290becf5f6c.png" alt="img" style="zoom:80%;" />
...
<img src="4131789-ae20b2d875793547.png" alt="img" style="zoom:80%;" />
